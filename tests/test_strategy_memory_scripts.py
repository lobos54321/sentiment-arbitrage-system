...
def test_strategy_memory_self_tests():
    ...
    run_script("exit_policy_shadow_lab.py", "--self-test")
    run_script("p7_exit_policy_oos_validation.py", "--self-test")
    ...
    run_script("agent_autoloop_stage_runner.py", "--self-test")
