...
def build_handoff(verdict):
    ...
    lines = [
        ...
        f"- final_eligibility_60_closure_classification: `{(verdict.get('final_eligibility_60_closure_priority_queue') or {}).get('classification')}`",
        f"- final_eligibility_60_closure_next_action: `{(verdict.get('final_eligibility_60_closure_priority_queue') or {}).get('next_action')}`",
