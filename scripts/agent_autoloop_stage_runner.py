...
REQUIRED_FINAL_ARTIFACTS = (
    ...
    "final_eligibility_60_oos_freeze_registry.json",
    "final_eligibility_60_oos_readiness_monitor.json",
...
def collect_paths(args, run_dir):
    ...
    readiness_names = {
        ...
        "matrix_alignment_false_negative_shadow_probe": f"matrix_alignment_false_negative_shadow_probe_{hours}h.json",
