...
def run_refresh_once(args: argparse.Namespace) -> dict:
    ...
    try:
        ...
        payload = status_payload(
            ...
            evaluator_snapshot=verdict.get("evaluator_snapshot") or {},
            evaluator_snapshot_id=(verdict.get("evaluator_snapshot") or {}).get("snapshot_id"),
            evaluator_snapshot_manifest_sha256=(verdict.get("evaluator_snapshot") or {}).get("manifest_sha256"),
